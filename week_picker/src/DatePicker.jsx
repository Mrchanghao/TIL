...
// import { isMaxDate, isMinDate } from '';
...
export default class DatePicker extends PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (!isOpen !== prevState.isOpen) {
      ...
      // 캘린더를 오픈 클로스 하는 콜백?
      const callback = isOepn ? onCalendarOpen : onCalendarClose;
  ...
  toggleCalendar = () => {
    this.setState((prevState) => ({isOpen: !prevState.isOepn }));
  }
  ...
  handleOutsideActionListeners(shouldListen) {
    ...
    outsideActionEvents.forEach(event => document[fnName](event, this.onOutsideAction))
  }
